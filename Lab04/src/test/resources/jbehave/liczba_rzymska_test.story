...
Given a LiczbaRzymska with argument 10
...
Given a LiczbaRzymska with argument 1999
Then the result should be MCMXCIX

Given a LiczbaRzymska with argument fbdbh
Then the result should be Zla liczba!

Given a LiczbaRzymska with argument 12.11
Then the result should be Zla liczba!

Given a LiczbaRzymska with argument -1
Then the result should be Zla liczba!
